...
const CACHE_VERSION = "moniezi-v39-5-4-2026-09-01-primary-heading-visual-hierarchy";
...
const CORE_ASSETS = [
  ...
  "./demo-business-v39-4-79-phone-480x800-optimized.webp",
  "./welcome-hero-v39-4-68-white.webp",
].map(toScopeUrl);
